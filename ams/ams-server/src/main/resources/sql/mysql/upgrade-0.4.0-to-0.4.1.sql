...
ALTER TABLE `optimize_task` ADD COLUMN `subtask_id` int(11) COMMENT 'Optimize task subtask id' after `queue_id`;
ALTER TABLE `optimize_task_history` ADD COLUMN `subtask_id` int(11) COMMENT 'Subtask id' after `queue_id`;
